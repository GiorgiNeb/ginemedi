...
<ul id="headerUl">
  ...
  <li>
    <a href="doctors.html"><i class="fa-solid fa-user-doctor"></i> ექიმები</a>
  </li>
  <li>
    <a href="about.html"><i class="fa-solid fa-circle-info"></i> ჩვენ შესახებ</a>
  </li>
  <li>
    ...
    <div class="subList">
      <ul>
        <li><a href="gynecology.html">გინეკოლოგია</a></li>
        <li><a href="echoscopy.html">ექოსკოპია</a></li>
        <li><a href="lab.html">ლაბორატორია</a></li>
      </ul>
    </div>
  </li>
  <li>
